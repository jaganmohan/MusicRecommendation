...
if __name__ == "__main__":
    ...
    def conv_net(_X, _weights, _biases, _dropout):
        ...
        # Output, latent factor prediction
    ...
    weights = {
        ...
        # 2^13 inputs, output = latent factor size
        'out': tf.Variable(tf.random_normal([8192, emb_dim]))
    }
    ...
    biases = {
        ...
        'out': tf.Variable(tf.random_normal([emb_dim])+0.01)
    }
